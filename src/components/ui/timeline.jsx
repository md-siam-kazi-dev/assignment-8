...
export const Timeline = ({
  ...
  return (
    <div
      className="container-div mx-auto bg-white dark:bg-neutral-950 font-sans "
      ref={containerRef}>
          ...
          <div key={index} className="flex justify-start pt-20  md:gap-10">
            <div
              ...
              <div
                ...
                <div
                  className="h-4 w-4 mx-auto rounded-full bg-neutral-200 dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 p-2" />
              </div>
              <h3
